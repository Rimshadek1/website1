...
if(status=="Invalidname"){
	swal("Congrts","Please enter Name","error");
}
if(status=="Invaliduemail"){
	swal("Congrts","Please enter Email","error");
}
if(status=="Invalidupwd"){
	swal("Congrts","Please enter password","error");
}
if(status=="Invalidumobile"){
	swal("Congrts","Please enter mobile number","error");
}
if(status=="Missmatch"){
	swal("Congrts","Please enter matching password","error");
}
if(status=="Invalidumobilenumber"){
		swal("Congrts","Please enter valid number","error");
}
</script>
</body>
